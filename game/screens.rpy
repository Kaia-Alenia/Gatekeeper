...
style navigation_button:
    ...
    # Esto hace que el botón se ilumine o cambie ligeramente de fondo (opcional)
    # background None

style navigation_button_text:
    properties gui.text_properties("navigation_button")
    
    # Color verde neón (similar a tu imagen)
    color "#33ff00" 
    
    # Color al pasar el mouse (Blanco o Cian para resaltar)
    hover_color "#ffffff"
    
    # Borde negro para que se lea bien sobre el cráneo si se cruzan
    outlines [(2, "#000000", 0, 0)]
    
    # Opcional: Si tienes una fuente pixelada, descomenta esto:
    # font "gui/fonts/mi_fuente_hacker.ttf"
...
style main_menu_frame:
    ...
    # Cambiamos la imagen por None para que sea invisible
    background None 
    # Antes decía: background "gui/overlay/main_menu.png"
    ...
    use game_menu(_("Opciones"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("Idioma") # O "Language"
                    
                    # Botón para el idioma original (por defecto)
                    textbutton "Español" action Language("spanish")
                    
                    # Botón para Español (debe coincidir con tu carpeta en game/tl/)
